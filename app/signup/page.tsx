...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-blue-400 to-purple-500 p-6">
      <form onSubmit={onSubmit} className="w-full max-w-sm bg-white border-8 border-yellow-400 rounded-xl shadow-xl p-6 space-y-4">
        <h1 className="text-2xl font-extrabold text-purple-800">Sign Up</h1>
        ...
        <button type="submit" className="w-full bg-yellow-400 hover:bg-yellow-500 text-purple-900 font-extrabold border-2 border-yellow-500 rounded p-2">Create Account</button>
        <p className="text-sm text-purple-700">Already have an account? <Link href="/login" className="font-bold underline">Login</Link></p>
      </form>
    </div>
  )
}
